---
title: 我所理解的技术音频技能路线（第二版）
date: 2020-12-01T16:46:00+08:00
tags:
  - 音频编程
aliases:
  - /2020/11/19/技术音频的技能路线/
---
大家好，我是溪夜。
...
## 编程技能
如果说**技术音频**或**音频程序员**需要会编程，为什么听起来和代码毫无关系的**声音设计师**也要学习编程？
对于这个问题，可以从两点解释：
...
**其一是对数曲线，在初期学习速度与收益飞快，并逐渐进入平台期**，多见于入门简单技能的学习。其二是指数曲线，初期无论是学习速度还是收益都很差，但**复利**效应强大，后期会获得爆发性的突破。多见于各种产生**睡后收入**的场景，如写文章、教程、创作文艺作品等。
...
虽然也可归纳为**信息检索与解决问题**或**音频基础知识**的匮乏，但我还是认为一个技术音频设计师也应该在传统音频领域有所建树，对于录音棚装修设计、音频设备解决方案设计、软件设计等方面也应该有着比较全面的见解。
